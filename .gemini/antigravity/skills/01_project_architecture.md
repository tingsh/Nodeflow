...
- **Description:** Complete map of the Novena Hub and Edge repositories, app inventory, data hierarchy, and system architecture.
...
## 1. System Overview
Novena is a multi-tenant Industrial IoT SaaS platform. It consists of:
1. **Novena Hub:** Django-based control plane, telemetry ingestion, and dashboard.
2. **Novena Gateway:** Python-based gateway software for local protocol conversion (Modbus, OPC-UA, etc.).

## 2. Codebase Structure (Novena Hub)
...
- `novena_hub/`: Core settings, WSGI/ASGI, and base URL configuration.
