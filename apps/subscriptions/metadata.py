...
ACTIVE_PRODUCTS = [
    ProductMetadata(
        ...
        slug="starter",
        name=_("Starter"),
        description=_("For micro-sites and pilots"),
        features=[
            _("Up to 10 Devices"),
            _("Real-time Dashboards"),
            _("Email Alerts"),
        ],
    ),
    ProductMetadata(
        ...
        slug="professional",
        name=_("Professional"),
        description=_("For small factories and facilities"),
        is_default=True,
        features=[
            _("Up to 50 Devices"),
            _("AI Anomaly Detection"),
            _("Daily Energy Reports"),
