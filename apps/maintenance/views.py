...
from .models import MaintenanceTicket, TicketTemplate, PreventiveSchedule, TicketComment
from .forms import MaintenanceTicketForm, TicketTemplateForm, PreventiveScheduleForm, TicketCommentForm
