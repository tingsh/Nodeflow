---
name: novena-hub-development-workflow
description: Use when starting, debugging, or verifying the Novena Hub local development stack, WSL2 services, Django/Celery/Vite/Mosquitto/Redis/PostgreSQL commands, local hardware testing, or environment-specific troubleshooting.
---
